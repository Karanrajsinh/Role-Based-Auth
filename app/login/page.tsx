      ...
      <SignIn
        ...
        appearance={{
          elements: {
            ...
            headerSubtitle: "text-base sm:text-lg text-gray-600 dark:text-gray-600",
            ...
            formButtonPrimary: "bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-800 dark:to-gray-400 hover:opacity-90 transition-opacity h-11",
